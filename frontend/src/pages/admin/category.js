        ...
        <div class="col py-3">
          <div class="card from-card shadow-sm p-4 mb-5 bg-white rounded">
            <div>
              ...
              {states ? (
                <>
                  <button type="submit" class="btn btn-primary mt-4 mb-1" onClick={() => categoryEdit()}>
                    Submit
                  </button>
                </>
              ) : (
                <button type="submit" class="btn btn-primary mt-4 mb-1" onClick={() => categoryAdd()}>
                  Submit
                </button>
              )}
            </div>
                  ...
                  return (
                    <tr key={index}>
                      ...
                      <td class="d-flex justify-content-around">
                        ...
                        <Link to={'/subCategory/' + value._id} class="manage-icon">
