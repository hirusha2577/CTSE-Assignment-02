                  ...
                  <div class="accordion-item" key={index}>
                    <h2 class="accordion-header" id="flush-headingOne">
                      <button
                        ...
                        onClick={() => getSubCategory(value._id)}
                      >
                        {value.name}
                      </button>
                    </h2>
                    ...
                    >
                      <div class="accordion-body">
                        {subCategory.map((value2, index1) => {
                          return (
                            <ul class="listitem" key={index1}>
                              <button
                                class="list-group-item sub-item-btn"
                                onClick={() => getProduct(value._id, value2._id)}
                              >
                                {' '}
                                {value2.name}
                              </button>
        ...
        <div class="col mt-5  ">
          <div class="row d-flex flex-wrap">
            {product.map((value, index) => {
              return (
                <div class="col-md-3 product-container" key={index}>
